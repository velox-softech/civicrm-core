...
<div class="crm-block crm-form-block crm-case-caseview-form-block">
  ...
  <div class="case-control-panel">
    ...
    <div>
      <p>
        {if $hasAccessToAllCases}
          <a class="crm-hover-button action-item no-popup" href="{crmURL p='civicrm/case/report/print' q="all=1&redact=0&cid=$contactID&caseID=$caseId"}"><i class="crm-i fa-print"></i> {ts}Print Report{/ts}</a>
        {/if}
